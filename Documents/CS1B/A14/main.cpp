...
int main ()
{
	...
	// First person with personType template
	pointer[0] = new personType("Alicia", "Mark", "821 Calle Campana", 'F', "02/03/2003", 56.7);

	//Second person is father
	...
	// Second person (student) that has a mother of personType above and father of professortype.
