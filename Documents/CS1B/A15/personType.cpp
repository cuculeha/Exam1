...
{
	out << obj.getFName () << " " << obj.getLName () << endl;
	out << obj.getAddress() << endl;
	out << "Height : " <<obj.getHeight () << " inches"<< endl;
	out << obj.getDOB () << endl;

	return out;
}

istream &operator>> (istream &in, personType &obj)
{
	string full;
	string fName = "";
	string lName = "";
...
bool personType:: operator== (const personType &obj) const
{
